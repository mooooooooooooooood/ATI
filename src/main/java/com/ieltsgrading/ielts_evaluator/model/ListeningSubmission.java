...
/**
 * Listening Submission Entity - Implements ITestSubmission
 */
@Entity
@Table(name = "listening_submission")
public class ListeningSubmission implements ITestSubmission {
    ...
    @Transient
    private IeltsListeningTest test;
    ...
    public String getTestDisplayName() {
        if (test != null) {
            return "CAM " + test.getCamNumber() + " - Listening Test " + test.getTestNumber();
        }
    ...
    public IeltsListeningTest getTest() {
        return test;
    }

    public void setTest(IeltsListeningTest test) {
        this.test = test;
    }
